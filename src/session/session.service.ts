 ...
 * Uses Firestore for persistence with sliding TTL.
 */
...
import type { SessionRecord, SessionStatus, TurnEntry } from '../types/domain.js';
...
/**
 * Close a session with a terminal status and publish a best-effort event.
 */
...
/**
 * Resume a prior session by creating a new session with carried-forward history.
 */
