/**
 * Dynamic prompt construction for the Gemini classifier
 * Builds prompts with agent descriptions and few-shot examples
 */
...
/**
 * Build the full prompt for classification
 */
